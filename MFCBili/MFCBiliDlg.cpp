...
// MFCBiliDlg.cpp : implementation file
//
...
// CMFCBiliDlg message handlers

BOOL CMFCBiliDlg::OnInitDialog()
{
...
void CMFCBiliDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMFCBiliDlg::OnQueryDragIcon()
{
